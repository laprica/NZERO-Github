...
logs_folder_path = "C:\\Users\\MOLNAR_PH330_D1\\Desktop\\NZERO\\python_code\\logs\\SOI8-10-M1R-13\\DC Test\\"
...
def main():
    ...
    if worked:
        print('{} contact switched at {} V with {} A'.format(device_name, bias_volt, cont_curr))
        printStatus()
        data.warn('{} contact switched at {} V with {} A'.format(device_name, bias_volt, cont_curr))
